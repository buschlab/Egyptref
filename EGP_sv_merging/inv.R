...
df = read.table("inv.txt", header=TRUE, sep="\t", as.is=TRUE, na.strings = c("NA"))
...
fwrite(res, "inv.collapsed.txt", sep="\t", col.names=TRUE, row.names=FALSE, quote=FALSE)
...
ggsave("inv.collapsed.core_length_per_chr.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("inv.collapsed.counts_per_ind_chr.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("inv.collapsed.lengths_per_ind.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("inv.collapsed.counts_per_chr.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("inv.collapsed.counts_per_ind_log10.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")