...
df = read.table("del.txt", header=TRUE, sep="\t", as.is=TRUE, na.strings = c("NA"))
...
fwrite(res, "del.collapsed.txt", sep="\t", col.names=TRUE, row.names=FALSE, quote=FALSE)
...
ggsave("del.collapsed.core_length_per_chr.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("del.collapsed.counts_per_ind_chr.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("del.collapsed.lengths_per_ind.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")



uniq_df_plot = df_plot[!delicated(df_plot$sv),]
...
ggsave("del.collapsed.counts_per_chr.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")
...
ggsave("del.collapsed.counts_per_ind_log10.png", plot=last_plot(), dpi=300, width=20, height=10, scale=1.2, units="cm")